...
const Icon = ({ name, size = 24, color = "currentColor", className = "" }) => {
  ...
  const icons = {
    ...
    /* ロゴ候補: 交配のXマークをイメージした独自アイコン */
    'cross-breed': <><path d="M18 6L6 18M6 6l12 12"/><circle cx="6" cy="6" r="2.5"/><circle cx="18" cy="6" r="2.5"/><circle cx="12" cy="18" r="2.5"/></>,
    /* ロゴ候補: 2つの線が交わるgit-merge風 */
    ...
    'trash-2': <><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4h6v2"/></>,
  };
