                            ...
                            <div key={i.id} className="card flex items-center gap-4" style={{padding: '12px', cursor: 'pointer', boxShadow: 'none', border: '1px solid var(--border-color)'}} onClick={() => onSelect(i.id)}>
                               ...
                               <div style={{flex: 1}}>
                                   <div style={{display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '4px', flexWrap: 'wrap'}}>
                                     ...
                                     {i.sex && <span style={{fontSize: '0.75rem', padding: '1px 7px', borderRadius: '20px', display: 'inline-flex', alignItems: 'center', lineHeight: 1, background: i.sex === '♀' ? 'rgba(255,77,79,0.1)' : i.sex === '♂' ? 'rgba(24,144,255,0.1)' : 'rgba(0,0,0,0.05)', color: i.sex === '♀' ? '#c0392b' : i.sex === '♂' ? '#2980b9' : 'var(--text-secondary)', fontWeight: 600}}>{i.sex}</span>}
                                   </div>
